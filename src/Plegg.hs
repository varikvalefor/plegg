...
import Data.Char;
  ...
  -- | = la .lojban.
  --
  -- ni'o pilno lo skami poi na mapti la'o gy. @pledge(2) .gy.  .i ja'e
  -- la'o zoi. @plegg k@ .zoi. cu narplixau
  --
  -- = English
  --
  ...
  -- | = la .lojban.
  --
  -- ni'o pilno lo skami poi na mapti la'o gy. @unveil(2) .gy.  .i ja'e
  -- la'o zoi. @univac k@ .zoi. cu narplixau
  --
  -- = English
  --
  -- This library is compiled on a system which does not support
